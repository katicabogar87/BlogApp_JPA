DROP DATABASE IF EXISTS  blogAppDB;
...
INSERT INTO blog_user (user_id, login_name, password, email, first_name, last_name, role, is_suspended  ) VALUES
			(3, 'Thor', 'hgehsna43f', 'thor@avengers.com', 'Thor', 'son of Odin', 'REG_USER', false),
            (4, 'CaptainAmerica', 'jh3736fn', 'captainamerica@avangers.com', 'Steve',  'Rogers', 'ADMIN', false),
            (5, 'Hulk', 'jkhnx654378rtg', 'hulk@avangers.com', 'Bruce', 'Banner', 'MODERATOR', false),
            (6, 'BlackWidow', 'hb36poj', 'blackwidow@avangers.com', 'Natasa', 'Romanoff', 'MODERATOR', false),
            (7, 'Hawkeye', 'jrhen7489p', 'hawkeye@avangers.com', 'Clint' , 'Barton', 'REG_USER', false),
            (8, 'Loki', 'cjsnc7486839', 'loki@avangers.com', 'Loki' , '', 'REG_USER', true);
